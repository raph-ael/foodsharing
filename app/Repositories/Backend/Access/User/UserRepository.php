...
class UserRepository extends BaseRepository
{
     ...
     * @param array $input
     */
    public function create($input, $notify = true)
    {
        $data = $input['data'];
        $roles = $input['roles'];
        ...
        DB::transaction(function () use ($user, $data, $roles, $notify) {
            if ($user->save()) {
     ...
     */
    public function update(Model $user, array $input, $notify = true)
    {
        $data = $input['data'];
        $roles = $input['roles'];
     ...
     * @return bool
     */
    public function updatePassword(Model $user, $input, $notify = true)
    {
