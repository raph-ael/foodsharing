...
$upload_dir = '/images/upload/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../images/upload/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../images/upload_thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$default_language="de_DE"; //default language file name
...
$ext_file = array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv','psd','sql','log','fla','xml','ade','adp','mdb','accdb','ppt','pptx','odt','ots','ott','odb','odg','otp','otg','odf','ods','odp','css','ai'); //Files
