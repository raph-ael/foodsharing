...
jQuery(document).ready(function ($) {
    ...
    $('#form-keyops').on('ajax:success', function (e, data) {
        ...
        elem.html(data);
        elem.find('.fstrans_editable').fstrans_editable();
    });
    ...
    elemAutoTrans.each(function () {
        ...
        btnElem.on('click', function (e) {
            ...
            $(".auto-translatable-" + dstLoc).each(function () {
                var row = $(this).parent().find('.fstrans_editable');
                if (row.length > 1) {
                    var srcElem = $(row[0]),
                        dstElem = $(row[colNum]),
                        tr = row.closest('tr');
    ...
    elemAutoFill.on('click', function (e) {
        ...
        $(".auto-fillable").each(function () {
            var dstElem = $(this).find("a.fstrans_editable.editable-empty"),
        ...
        btnElem.on('click', function (e) {
            ...
            $(".auto-translatable-" + dstLoc).each(function () {
                ...
                if (!row.hasClass('hidden')) {
                    var editable = $(this).parent().find('.fstrans_editable');
