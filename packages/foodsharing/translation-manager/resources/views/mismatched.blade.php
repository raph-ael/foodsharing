    ...
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">@lang('translation-manager.mismatches')</h3>
            </div>
            <div class="panel-body">
                <table class="table table-condensed translation-stats" style="max-height: 300px; margin-bottom: 0; overflow: auto; display: block;">
                    <thead>
                        <tr>
                            <th class="key" width="20%">@lang('translation-manager.key')</th>
                            <th width="20%" colspan="2"><?=$translatingLocale?></th>
                            <th width="20%"><?=$primaryLocale?></th>
                            <th class="group" width="20%">@lang('translation-manager.group')</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
