...
use Foodsharing\TranslationManager\Classes\PathTemplateResolver;
use Foodsharing\TranslationManager\Classes\TranslationFileRewriter;
 ...
 * Class Manager
 *
 * @package Foodsharing\TranslationManager
 */
class Manager
{
    ...
    /**
     * @return \Foodsharing\TranslationManager\Models\Translation
     */
     ...
     *
     * @return \Foodsharing\TranslationManager\Models\Translation|null
     */
        ...
        if (!$useLottery || $this->config(self::LOG_MISSING_KEYS_KEY)) {
            ...
            if (!in_array($group, $this->config(self::EXCLUDE_GROUPS_KEY))) {
                ...
                if ($lottery === 1) {
                    ...
                    /* @var $translation \Foodsharing\TranslationManager\Models\Translation */
                    return $translation;
                }
            }
        }
