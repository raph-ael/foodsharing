...
{
    const PACKAGE = 'translation-manager';
    ...
    public function register()
    {
        ...
        $this->app->singleton(self::PACKAGE, function ($app) {
            /* @var $manager \Foodsharing\TranslationManager\Manager */
            $manager = $app->make('Foodsharing\TranslationManager\Manager');
            return $manager;
        });
    ...
    public function boot(Router $router)
    {
        ...
        $config['namespace'] = 'Foodsharing\TranslationManager';
        ...
        $router->pushMiddlewareToGroup('web', 'Foodsharing\TranslationManager\RouteAfterMiddleware');
    }
