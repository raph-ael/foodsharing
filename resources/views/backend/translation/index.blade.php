...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.translation.title') }}</h3>
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table id="groups-table" class="table table-condensed table-hover">
                    <thead>
                    <tr>
    ...
    <script>
        $(function () {
            $('#users-table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route("admin.translation.groups.get") }}',
                    type: 'post',
