<div class="alert alert-default alert-dismissible" role="alert" style="padding-top: 0; padding-bottom: 0; margin: 0;">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4><?= \Lang::get('translation-manager.keyop-header-' . $op, ['group' => $group]) ?></h4>
    </div>
    <div class="panel-body">
        ...
        <?php if (!empty($keymap)): ?>
          <table class="table table-condensed" style="margin-bottom: 0;">
            <thead>
              <tr>
                <th width="15%"><?= trans('translation-manager.srckey') ?></th>
                <th width="15%"><?= trans('translation-manager.dstkey') ?></th>
                <th width="70%">&nbsp;</th>
              </tr>
            </thead>
            <tbody>
                        ...
                        <td><?= $map['dst'] ?></td>
                            ...
                            <table class="table table-striped table-condensed">
                              <thead>
                                <tr>
                                  ...
                                  <th width="25%"><?= trans('translation-manager.src-preview') ?></th>
                                  <th width="5%">&nbsp;</th>
                                  <th width="25%"><?= trans('translation-manager.dst-preview') ?></th>
                                </tr>
                              </thead>
                              <tbody>
                          ...
                          <td>
                            <div class="alert alert-info alert-dismissible">
                              ...
                              <ul>
                                <li><?= trans('translation-manager.keyop-no-match') ?></li>
                              </ul>
                            </div>
                          </td>
                          <?php endif ?>
